...
def test_braid_delta():
    ...
    model = BRAID(E0=E0, E1=E1, E2=E2, E3=E3, h1=h1, h2=h2, C1=C1, C2=C2, delta=delta, variant="delta")
...
def test_braid_both():
    ...
    model = BRAID(E0=E0, E1=E1, E2=E2, E3=E3, h1=h1, h2=h2, C1=C1, C2=C2, kappa=1, delta=delta, variant="both")

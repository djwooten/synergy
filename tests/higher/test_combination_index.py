...
from synergy.higher.combination_index import CombinationIndex
...
class CombinationIndexNDTests(TestCase):
    """Tests for the CombinationIndex N-drug model."""

    def test_fit_reference(self):
        """Ensure N-drug CombinationIndex model gives 0 synergy for its reference model"""
        np.random.seed(1204808)
        ...
        # TODO implement E_reference for Loewe or CombinationIndex so that we can use it (and h != 1) instead
    ...
    def test_fit_sham(self):
        """Ensure N-drug CombinationIndex model gives 0 synergy for a sham experiment"""
        np.random.seed(7103487)
    ...
    def test_msa_synergy(self):
        """Ensure N-drug CombinationIndex model gives synergy > 0 for Bliss data.

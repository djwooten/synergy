...
class MuSyCGNew(ParameterizedModelNew):
    ...
    def __init__(self, h1_bounds=(0,np.inf), h2_bounds=(0,np.inf),  \
        ...
        self.alpha12 = MuSyCGNew._prime_to_alpha(oalpha12, C2, gamma12)
        self.alpha21 = MuSyCGNew._prime_to_alpha(oalpha21, C1, gamma21)
        #self.oalpha12 = MuSyCGNew._alpha_to_prime(alpha12, C2, gamma12)
        #self.oalpha21 = MuSyCGNew._alpha_to_prime(alpha21, C1, gamma21)
        ...
        self.jacobian_function = lambda d, E0, E1, E2, E3, logh1, logh2, logC1, logC2, logalpha12, logalpha21, loggamma12, loggamma21: musyc_jacobian_gamma.jacobian(d[0], d[1], E0, E1, E2, E3, logh1, logh2, logC1, logC2, self.r1, self.r2, logalpha12, logalpha21, loggamma12, loggamma21)
    ...
    def __repr__(self):
        ...
        oalpha12 = MuSyCGNew._alpha_to_prime(self.alpha12, self.C2, self.gamma12)
        oalpha21 = MuSyCGNew._alpha_to_prime(self.alpha21, self.C1, self.gamma21)

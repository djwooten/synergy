...
from synergy.higher import Loewe, MuSyC
...
# single_models = [Hill(E0=1, Emax=0.5, h=1, C=0.1), Hill(E0=1, Emax=0.5, h=1, C=0.01), Hill(E0=1, Emax=0.5, h=1, C=0.1)]
single_models = [
    Hill(E0=1, Emax=0.5, h=2, C=0.1),
    Hill(E0=1, Emax=0.5, h=1, C=0.01),
    Hill(E0=1, Emax=0.5, h=0.8, C=0.1),
]

d = dose_tools.make_dose_grid_multi((1e-3, 1e-3, 1e-3), (1, 1, 1), (6, 6, 6), include_zero=False)

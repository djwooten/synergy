...
d1, d2, E = MuSyCDataGenerator.get_2drug_combination(E0=1, E1=0.2, E2=0.1, E3=0.4, h1=2.3, h2=0.8, C1=1e-2, C2=1e-1, alpha12=3.2, alpha21=1.1, n_points1=8, n_points2=12)

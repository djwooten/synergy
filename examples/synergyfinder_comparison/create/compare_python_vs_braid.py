...
for i in [1,2,3]:
    ...
    for variant in ['kappa','delta','both']:
        ...
        kappa=0
        delta=1
        if "kappa" in braidrm_fits.index: kappa=braidrm_fits.loc['kappa','best']
        if "delta" in braidrm_fits.index: kappa=braidrm_fits.loc['delta','best']
        braidrm_model = BRAID(variant=variant, E0=braidrm_fits.loc['E0','best'], E1=braidrm_fits.loc['E1','best'], E2=braidrm_fits.loc['E2','best'], E3=braidrm_fits.loc['E3','best'], h1=braidrm_fits.loc['h1','best'], h2=braidrm_fits.loc['h2','best'], C1=braidrm_fits.loc['C1','best'], C2=braidrm_fits.loc['C2','best'], kappa=kappa, delta=delta)

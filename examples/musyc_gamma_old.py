...
oalpha12 = MuSyCG._alpha_to_prime(alpha12, C2, gamma12)
oalpha21 = MuSyCG._alpha_to_prime(alpha21, C1, gamma21)
...
truemodel.plot_surface_plotly(DD1, DD2, fname="_old_musyc_gamma.html", scatter_points=scatter_points)


#model.plot_surface_plotly(DD1, DD2, fname="_old_musyc_gamma_fit.html", scatter_points=scatter_points)

#model_no_gamma.plot_surface_plotly(DD1, DD2, fname="_old_musyc_nogamma_fit.html", scatter_points=scatter_points)
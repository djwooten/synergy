...
def ds_A_3(noise=0.05):
    ...
    d = dose_utils.make_dose_grid_multi((1e-3, 1e-3, 1e-3), (1, 1, 1), (6, 6, 6), include_zero=True)
...
def ds_B_3(noise=0.05):
    E_params = [1, 0.45, 0.4, 0.4, 0.3, 0.3, 0.3, 0.0]
...
def ds_C_3(noise=0.05):
    E_params = [1, 0.45, 0.4, 0.55, 0.2, 0.1, 0.3, 0.0]
    h_params = [0.3, 0.8, 1.3]
    C_params = [0.1, 0.01, 0.1]

...
def sanitize_single_drug_model_OLD(model, default_class, expected_superclass=None, **kwargs):
        ...
        if expected_superclass is None:
            ...
            # The given class violates the expected class: return the default
                ...
                if model is not None:
                    warnings.warn(
                        "Expected single drug model to be subclass of %s, instead got %s" % (expected_superclass, model)
                    )
    ...
    # The model is an object
        ...
        # The model is an instance of the wrong type of class, so return the default
            ...
            if model is not None:
                warnings.warn(
                    "Expected single drug model to be subclass of %s, instead got %s"
                    % (expected_superclass, type(model))
                )
